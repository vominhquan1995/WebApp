...
public class ProductAttributePresenter {
    private static final String TAG = ProductAttributePresenter.class.getSimpleName();

    private static final String API = Host.DEFAULT_HOST + WCApi.PRODUCT_ATTRIBUTE;
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected void onPostExecute(String result) {
                        ...
                        if (result != null) {
                            ...
                            try {
                                ProductAttribute productAttribute = new Gson().fromJson(result, ProductAttribute.class);
                                callback.onResponse(productAttribute);
                                return;
    ...
    public interface RetrieveCallback extends WCCallback {
        ...
        void onResponse(ProductAttribute productAttribute);
    }
                ...
                new AsyncTask<Void, Void, String>() {
                    ...
                    protected void onPostExecute(String result) {
                        ...
                        if (result != null) {
                            Log.d(TAG, "onPostExecute: " + result);
                            try {
                                ProductAttribute[] productAttributeArray = new Gson().fromJson(result, ProductAttribute[].class);
                                List<ProductAttribute> productAttributes = new ArrayList<>(Arrays.asList(productAttributeArray));
                                callback.onResponse(productAttributes);
                                return;
                            } catch (JsonSyntaxException | IllegalStateException ex) {
                                ex.printStackTrace();
                            }
    ...
    public interface ListAllCallback extends WCCallback {
        ...
        void onResponse(List<ProductAttribute> productAttributes);
    }
}
