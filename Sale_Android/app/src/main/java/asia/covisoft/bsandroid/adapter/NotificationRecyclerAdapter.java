...
public class NotificationRecyclerAdapter extends BaseEndlessRecyclerAdapter<Notification> {
    ...
    @Override
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position, Notification item) {
