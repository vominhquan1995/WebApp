...
public class NotificationDetailsActivity extends BaseLoadingActivity {
    ...
    public void initView() {
        ...
        updateToolbar(getString(R.string.up_notifications), true);
    ...
    private String image, title, date, content, notifcationId;
    ...
    public void initValue() {
        ...
        notifcationId = extras.getString(NOTIFICATION_ID);
    }
...
//        wvNews.getSettings().setUserAgentString("Mozilla/5.0 (iPhone; U; CPU like Mac OS X; en) AppleWebKit/420+ (KHTML, like Gecko) Version/3.0 Mobile/1A543a Safari/419.3");
        wvNews.loadUrl(WAApi.NEWS_PRODUCT_CONTENT + notifcationId);
    }
